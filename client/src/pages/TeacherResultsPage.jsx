...
export default function TeacherResultsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <p className="text-sm font-semibold text-cyan-300">EXAM RESULTS</p>
      <h1 className="mt-1 text-3xl font-bold">Student performance</h1>
      <p className="mt-2 text-zinc-400">
        Review outcomes for examinations you created.
      </p>
        ...
        {isPending ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-200 text-left text-sm">
              <thead className="bg-white/[.025] text-xs uppercase text-zinc-500">
                <tr>
                  {[
                    "Student",
                    "Exam",
