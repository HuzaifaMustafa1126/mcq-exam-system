...
export default function QuestionPreviewModal({ questionId, onClose }) {
        ...
        <div>
          ...
          <div className="mt-5 space-y-2">
            {data.options.map((option, index) => (
              <div
                key={option.id}
                className={`flex items-center gap-3 rounded-xl border p-3 text-sm ${option.isCorrect ? "border-emerald-500/30 bg-emerald-500/10 text-emerald-200" : "border-white/10 bg-white/[.03] text-zinc-300"}`}
              >
