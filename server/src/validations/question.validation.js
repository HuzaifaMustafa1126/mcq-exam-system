...
const optionsValidation = [
  ...
  body("options.*.optionText")
    ...
    .bail()
    .isLength({ max: 5000 })
    .withMessage("Option text must not exceed 5000 characters"),
...
const questionIdValidation = param("id")
  .isInt({ min: 1 })
...
const questionTextValidation = body("questionText")
  .isString()
...
const marksValidation = body("marks")
  .isFloat({ min: 0.01, max: 999999.99 })
  .withMessage("Marks must be between 0.01 and 999999.99")
  .toFloat();

const difficultyValidation = body("difficulty")
